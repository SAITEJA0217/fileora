...
import { Mail, Lock, User, Loader2, ArrowRight, Layers } from 'lucide-react';
    ...
    <main className="min-h-screen bg-gray-50 dark:bg-[#0A192F] flex items-center justify-center p-4 transition-colors duration-500">
      ...
      >
        ...
        <div className="text-center mb-10">
          <h1 className="text-3xl font-black text-gray-900 dark:text-white mb-2">Join FileOra</h1>
          <p className="text-gray-500 dark:text-gray-400">The ultimate workspace for students and creators</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {loading ? <Loader2 className="w-6 h-6 animate-spin" /> : <>Create Account <ArrowRight className="ml-2 w-5 h-5" /></>}
          </button>
        </form>
